...
from maat import registered_functions, chain_validation
...
counter = {'filename': {'validator': 'valid_filename', 'max_length': 24, 'extenstions': ['png', 'jpg']}}

a = maat.scale({'filename': 'foo.bar'}, counter)
print(a)
